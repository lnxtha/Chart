    ...
    e.AmMap = e.Class({
        ...
        buildEverything: function() {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.processAreas();
                if (b = this.valueLegend) this.valueLegend = b = e.processObject(b,
                    e.ValueLegend, this.theme), b.init(this, a);
        ...
        handleMouseMove: function(a) {
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if (a = b.mapContainer) {
                    ...
                    k = a.scale;
                    b.isDragging && (b.balloon.hide(0), b.positionChanged(), c = a.x + (f - c), d = a.y + (g - d), b.preventDragOut && (r = -r * k + n / 2 - b.diffY * b.mapScale * k, n = n / 2 - b.diffY * b.mapScale * k, c = e.fitToBounds(c, -p * k + m / 2, m / 2), d = e.fitToBounds(d, r, n)), isNaN(c) || isNaN(d) || (a.translate(c, d, k, !0), b.updateSmallMap()));
                    b.previuosMouseX = f;
                    b.previuosMouseY = g
                }
            }
        ...
        selectObject: function(a, b) {
            ...
            if (d && !g && (e.isString(d) && (d = c.getObjectById(d)), isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY))) {
            ...
            if (d) {
                if (e.removeCN(c, d, "selected-object"), e.setCN(c, d, "selected-object"), a.bringForwardOnHover && a.displayObject.toFront(), c.outlinesToFront(), !a.preserveOriginalAttributes) {
                    ...
                    if (l = a.imageLabel) n = a.selectedLabelColorReal, void 0 !== n && l.setAttr("fill", n);
                    a.selectable || (d.setAttr("cursor", "default"), l && l.setAttr("cursor", "default"))
                }
            } else c.returnInitialColorReal(a);
            if (d = a.groupId)
                for (l = a.groupArray, l || (l = c.getGroupById(d), a.groupArray =
                        l), n = 0; n < l.length; n++)
                    if (m = l[n], m.isOver = !1, d = m.displayObject, "MapImage" == m.objectType && (d = m.image), d) {
                        var p = m.selectedColorReal;
                        void 0 !== p && d.setAttr("fill", p);
                        void 0 !== h && d.setAttr("stroke", h);
                        void 0 !== k && d.setAttr("stroke-width", k);
                        "MapLine" == m.objectType && ((d = m.lineSvg) && d.setAttr("stroke", g), d = m.arrowSvg) && (d.setAttr("fill", g), d.setAttr("stroke", g))
                    }
            c.rescaleObjects();
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                if (k = a.image) k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", g), k.setAttr("fill-opacity", d), k.setAttr("stroke-opacity",
                    f);
                "MapArea" == a.objectType && (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel() * this.mapScale), b.setAttr("stroke", h), b.setAttr("stroke-width", g / c), b.setAttr("fill-opacity", d), b.setAttr("stroke-opacity", f));
        ...
        zoomToObject: function(a) {
            if (a) {
                ...
                isNaN(d) || (isNaN(b) || isNaN(c) ? this.zoomTo(d,
                    g, h, f) : this.zoomToLongLat(d, c, b, f));
                ...
                "MapArea" == a.objectType && (f = a.displayObject.getBBox(), g = this.mapScale, b = (f.x + this.diffX) * g, c = (f.y + this.diffY) * g, d = f.width * g, f = f.height * g, k = a.autoZoomReal && isNaN(a.zoomLevel) ? d / k > f / l ? .8 * k / d : .8 * l / f : a.zoomLevel, l = this.zoomControl, k = e.fitToBounds(k,
        ...
        addObjectEventListeners: function(a, b) {
            ...
            a.mousedown(function(a) {
                ...
                "MapImage" != b.objectType ||
                    isNaN(b.longitude) || (f = b.longitude, e = b.latitude);
                "MapArea" == b.objectType && (f = c.getAreaCenterLongitude(b), e = c.getAreaCenterLatitude(b));
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                if ("MapArea" == a.objectType) {
                    ...
                    this.areasSettings.adjustOutlineThickness &&
                        (d = this.zoomLevel() * this.mapScale);
        ...
        resizeMap: function() {
            ...
            if (a) {
                var b = 1,
                    ...
                    e = c.width,
                    c = c.height;
                0 < e && 0 < c && (this.fitMapToContainer && (b = e / d > c / f ? d / e : f / c), a.translate(0, 0, b, !0), this.mapScale = b, this.mapHeight = c * b, this.mapWidth = e * b)
            }
        },
        zoomIn: function() {
        ...
        extendMapData: function(a) {
            var b = a.objectType;
            if ("MapImage" != b && "MapArea" != b && "MapLine" != b) return e.extend(a, new e.MapData, !0), this.dataProvider = a,
                ...
                for (f = 0; f < k; f++) {
                    ...
                    if (0 !== e.childNodes.length || "" !== n || !1 !== m)
                        ...
                        if (e.attributes && e.attributes.length)
                            for (n = 0; n < e.attributes.length; n++) p[e.attributes[n].name] = e.attributes[n].value;
        ...
        processObject: function(a, b, c) {
            if (a) {
                ...
                for (d = 0; d < a.length; d++) {
                    ...
                    f.lines &&
                        this.processObject(f.lines, f, "line")
                }
            }
        },
        ...
        normalizeMap: function() {
            ...
            for (n = 0; n < this.svgAreas.length; n++) this.normalize(this.svgAreas[n]);
        ...
        fixMapPosition: function() {
            ...
            c = g = Infinity;
            for (d = 0; d < this.svgAreas.length; d++) f = this.svgAreas[d].getBBox(), f.y < g && (g = f.y), f.x < c && (c = f.x);
            this.diffY =
                b.y / this.mapScale - g;
        ...
        xyToCoordinates: function(a, b, c, d, f) {
            ...
            if (g = c.invert) {
                ...
                this.projectionChanged && (l = e.radiansToDegrees(c(e.degreesToRadians(this.topLongLat.longitude), e.degreesToRadians(this.topLongLat.latitude))[1]), n = e.radiansToDegrees(c(e.degreesToRadians(this.bottomLongLat.longitude),
                    e.degreesToRadians(this.bottomLongLat.latitude))[1]), h = e.radiansToDegrees(c(e.degreesToRadians(this.leftLongLat.longitude), e.degreesToRadians(this.leftLongLat.latitude))[0]), k = e.radiansToDegrees(c(e.degreesToRadians(this.rightLongLat.longitude), e.degreesToRadians(this.rightLongLat.latitude))[0]));
...
(function() {
    ...
    e.ZoomControl = e.Class({
        ...
        init: function(a, b) {
            ...
            isNaN(c.bottom) || (x = a.getY(c.bottom, !0), g && (x -= q + 3 * f), x = h ? x - 3 * f : c.homeButtonEnabled ? x - .5 * f : x + f);
            d.translate(w, x);
            c.previousDY = NaN;
            var F, w = f / 4 - 1;
            if (g) {
                ...
                c.set = d;
                c.zoomSet = F;
                5 < q && (g = e.rect(b, f + 6, q + 2 * f + 6, c.gridBackgroundColor, c.gridBackgroundAlpha, 0, "#000000", 0, 4), e.setCN(a, g, "zoom-bg"), g.translate(-3, -3), g.mouseup(function() {
                    c.handleBgUp()
                }).touchend(function() {
                    c.handleBgUp()
                }), F.push(g));
                ...
                F.push(A);
                for (G = 1; G < H; G++) x = f + G * g, x = e.line(b, [1, D - 2], [x, x], c.gridColor, c.gridAlpha, 1), e.setCN(a, x, "zoom-grid"), A.push(x);
                ...
                c.previousY = NaN;
                x = new e.SimpleButton;
                z ? (D = b.set(), H = e.line(b, [-w, w], [0, 0], y, B, 1), G = e.line(b, [0, 0], [-w, w], y, B, 1), D.push(H), D.push(G), x.svgIcon = D) : x.setIcon(a.pathToImages + "plus.gif", c.iconSize);
            ...
            h && (h = b.set(), e.setCN(a, h, "zoom-control-pan"), d.push(h), F && F.translate(f, 4 * f), u = new e.SimpleButton, z ? u.svgIcon = e.line(b, [w / 5, -w + w / 5,
                w / 5
            ], [-w, 0, w], y, B, 1) : u.setIcon(a.pathToImages + "panLeft.gif", c.iconSize), u.setClickHandler(a.moveLeft, a), u.init(b, f, f, k, l, n, m, p, r, t, B, y, E), u.set.translate(0, f), e.setCN(a, u.set, "pan-left"), h.push(u.set), u = new e.SimpleButton, z ? u.svgIcon = e.line(b, [-w / 5, w - w / 5, -w / 5], [-w, 0, w], y, B, 1) : u.setIcon(a.pathToImages + "panRight.gif", c.iconSize), u.setClickHandler(a.moveRight, a), u.init(b, f, f, k, l, n, m, p, r, t, B, y, E), u.set.translate(2 * f, f), e.setCN(a, u.set, "pan-right"), h.push(u.set), u = new e.SimpleButton, z ? u.svgIcon = e.line(b, [-w, 0, w], [w / 5, -w + w / 5, w / 5], y, B, 1) : u.setIcon(a.pathToImages + "panUp.gif", c.iconSize), u.setClickHandler(a.moveUp, a), u.init(b, f, f, k, l, n, m, p, r, t, B, y, E), u.set.translate(f, 0), e.setCN(a, u.set, "pan-up"), h.push(u.set), u = new e.SimpleButton, z ? u.svgIcon = e.line(b, [-w, 0, w], [-w / 5, w - w / 5, -w / 5], y, B, 1) : u.setIcon(a.pathToImages + "panDown.gif", c.iconSize), u.setClickHandler(a.moveDown, a), u.init(b, f, f, k, l, n, m, p, r, t, B, y, E), u.set.translate(f, 2 * f), e.setCN(a, u.set, "pan-down"), h.push(u.set), d.push(h));
            c.homeButtonEnabled && (h = new e.SimpleButton,
                z ? h.svgIcon = e.polygon(b, [-w, 0, w, w - 1, w - 1, 2, 2, -2, -2, -w + 1, -w + 1], [0, -w, 0, 0, w - 1, w - 1, 2, 2, w - 1, w - 1, 0], y, B, 1, y, B) : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a), c.panControlEnabled && (p = l = 0), h.init(b, f, f, k, l, n, m, p, r, t, B, y, E), c.panControlEnabled ? h.set.translate(f, f) : F && F.translate(0, 1.5 * f), e.setCN(a, h.set, "pan-home"), d.push(h.set));
            c.update()
        },
        ...
        update: function() {
            ...
            var b = this.realStepSize,
                ...
                f = this.buttonSize,
                g, h = this.chart;
            h && (this.isDragging ? (h.stopDrag(), g = d.y + (h.mouseY - this.previousY), g = e.fitToBounds(g, f, this.realGridHeight + f), h.zoomTo(100 * Math.pow(a, c - (g - f) / b), NaN, NaN, !0)) : (a = Math.log(h.zoomLevel() / 100) / Math.log(a), g = (c - a) * b + f), this.previousY =
...
(function() {
    ...
    e.SimpleButton = e.Class({
        ...
        init: function(a, b, c, d, f, g, h, k, l, n, m, p, r) {
            ...
            n = a.set();
            t.set = n;
            r ? (b /= 2, d = e.circle(a, b, d, f, g, h, k), d.translate(b, b)) : d = e.rect(a, b, c, d, f, g, h, k, l);
            n.push(d);
            f = t.iconPath;
            var q;
            ...
            q && (n.push(q), q.setAttr("opacity",
                m), q.node.style.pointerEvents = "none");
    ...
    e.SmallMap = e.Class({
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                f.push(k);
                k.toBack();
                var l, n, k = c.minimizeButtonWidth,
                    m = new e.SimpleButton,
                    p = k / 2;
                a.svgIcons ? m.svgIcon = e.line(b, [-p / 2, 0, p / 2], [-p / 4, p / 4, -p /
                    4
                ], c.iconColor, 1, 1) : m.setIcon(a.pathToImages + "arrowDown.gif", k);
                ...
                isNaN(c.left) || (n = a.getX(c.left) + g, t = -g / 2);
                isNaN(c.right) || (n = a.getX(c.right, !0) - c.width - g, t = c.width - k + g / 2);
                g = b.set();
    ...
    e.AreasProcessor = e.Class({
        ...
        process: function(a) {
            ...
            var c = a.length,
                ...
                l = 0;
            for (d = 0; d < c; d++)
                if (e = a[d], e.value = Number(e.value), e = e.value, !isNaN(e)) {
                    if (!1 === h || h < e) h = e;
                    if (!1 === k || k > e) k = e;
                    g += Math.abs(e);
                    l++
            ...
            b.maxValueReal =
                h;
            b.minValueReal = k;
            for (d = 0; d < c; d++) e = a[d], isNaN(e.value) ? e.percents = void 0 : (e.percents = (e.value - k) / g * 100, k == h && (e.percents = 100));
        ...
        updateAllAreas: function() {
            ...
            for (m = 0; m < h.length; m++) {
                ...
                k.getAreasFromMap && !n[l.id] && (r = new e.MapArea(a.theme), r.parentObject = k, r.id = l.id, r.outline = l.outline, k.areas.push(r))
            }
        },
        createArea: function(a) {
            ...
            if (c && (p = c.area, B = c.title, a.enTitle = c.title, B && !a.title && (a.title = B), (c = b.language) ? (B = e.mapTranslations) && (c = B[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, p)) {
                c = a.tabIndex;
                ...
                a.preserveOriginalAttributes ||
                    (p.setAttr("fill", z), p.setAttr("stroke", g), p.setAttr("stroke-opacity", r), p.setAttr("stroke-width", t), p.setAttr("fill-opacity", E));
    ...
    e.ImagesProcessor = e.Class({
        ...
        createImage: function(a, b) {
            ...
            if (m) {
                ...
                "miles" == a.widthAndHeightUnits && (z = c.milesToPixels(a.width), D = c.milesToPixels(a.height));
                if ("circle" == m || "bubble" == m) D = z;
                A = this.createPredefinedImage(G, r, t, m, z, D);
                q = F = 0;
                a.centeredReal ? (isNaN(a.right) || (F = z * B), isNaN(a.bottom) || (q = D * B)) : (F = z * B / 2, q = D * B / 2);
                A.translate(F, q, B, !0)
            } else v ? (isNaN(z) && (z = 10), isNaN(D) && (D = 10), A = d.image(v, 0, 0, z, D), A.node.setAttribute("preserveAspectRatio", "none"), A.setAttr("opacity", k), a.centeredReal && (F = isNaN(a.right) ? -z / 2 : z / 2, q = isNaN(a.bottom) ?
                -D / 2 : D / 2, A.translate(F, q, NaN, !0))) : C && (A = d.path(C), v = A.getBBox(), a.centeredReal ? (F = -v.x * B - v.width * B / 2, isNaN(a.right) || (F = -F), q = -v.y * B - v.height * B / 2, isNaN(a.bottom) || (q = -q)) : F = q = 0, A.translate(F, q, B, !0), A.x = F, A.y = q);
            A && (H.push(A), a.image = A, A.setAttr("stroke-opacity", l), A.setAttr("stroke-width", t), A.setAttr("stroke", r), A.setAttr("fill-opacity", k), "bubble" != m && A.setAttr("fill", G), e.setCN(c, A, "map-image"), void 0 != a.id && e.setCN(c, A, "map-image-" + a.id));
            G = a.labelColorReal;
            !a.showAsSelected && c.selectedObject !=
                a || void 0 == h || (A && A.setAttr("fill", h), G = a.selectedLabelColorReal);
            A = null;
            void 0 !== a.label && (A = e.text(d, a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign), e.setCN(c, A, "map-image-label"), void 0 !== a.id && e.setCN(c, A, "map-image-label-" + a.id), G = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < G && (l = A.getBBox(), d = e.rect(d, l.width + 16, l.height + 10, k, G), e.setCN(c, d, "map-image-label-background"), void 0 != a.id && e.setCN(c, d, "map-image-label-background-" + a.id), H.push(d), a.labelBG = d), a.imageLabel = A, H.push(A),
                e.setCN(c, H, "map-image-container"), void 0 != a.id && e.setCN(c, H, "map-image-container-" + a.id), this.labelsToReposition.push(a), a.arrays.push({
        ...
        updateSizeAndPosition: function(a) {
            ...
            if (a.line && a.line.getCoordinates) {
                ...
                t && (k = b.coordinateToLongitude(t.x), l = b.coordinateToLatitude(t.y), p = t.x, r = t.y, a.animateAngle && (g = e.radiansToDegrees(t.angle)))
            }
            isNaN(g) || c.rotate(g + a.extraAngle);
            if (!isNaN(d) && !isNaN(f)) c.translate(d, f, NaN, !0);
            else if (!isNaN(l) && !isNaN(k))
                if (f = b.coordinatesToXY(k, l), d = f.x, f = f.y, isNaN(p) || (d = p), isNaN(r) || (f = r), a.fixedSize) {
                    p = a.positionScale;
                    isNaN(p) ? p = 0 : (--p, p *= 1 - 2 * Math.abs(n - .5));
                    if (n = a.objectToResize) n.scale = 1 + p;
        ...
        positionLabel: function(a, b, c) {
            if (a) {
                var d = b.image,
                    ...
                    h = 0,
                    k = 0;
                d && (k = d.getBBox(), g = d.y + k.y, e = d.x + k.x, h = k.width, k = k.height, b.svgPath && (h *= b.scale, k *= b.scale));
                var d = a.getBBox(),
                    l = d.width,
                    n = d.height;
                "right" == c && (e += h + l / 2 + 5, g += k / 2 - 2);
                "left" == c && (e += -l / 2 - 5, g += k / 2 - 2);
                "top" == c && (g -= n / 2 + 3, e += h / 2);
                "bottom" == c && (g += k + n / 2, e += h / 2);
                "middle" == c && (e += h / 2, g += k / 2);
                a.translate(e + b.labelShiftX, g + b.labelShiftY, NaN, !0);
                a = b.labelFontSizeReal;
                b.labelBG && b.labelBG.translate(e - d.width / 2 + b.labelShiftX - 9, g - a / 2 + b.labelShiftY -
                    4, NaN, !0)
            }
        },
        createPredefinedImage: function(a, b, c, d, f, g) {
            ...
            switch (d) {
                ...
                case "bubble":
                    ...
                    break;
                case "hexagon":
                    f /= Math.sqrt(3), k = e.polygon(h, [.866 * f, 0 * f, -.866 * f, -.866 * f, 0 * f, .866 * f], [.5 * f, 1 * f, .5 * f, -.5 * f, -1 * f, -.5 * f], a, 1, c, b, 1)
            }
            return k
        },
        reset: function() {
    ...
    e.LinesProcessor = e.Class({
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                q = m.length;
                if (0 < q)
                    for (y = [], z = [], v = 0; v < q; v++) C = c.coordinatesToXY(m[v], d[v]), y.push(C.x), z.push(C.y);
                if (0 < y.length) {
                    a.segments = y.length;
                    e.dx = 0;
                    e.dy = 0;
                    ...
                    if (isNaN(q)) {
                        for (q = 0; q < y.length -
                            1; q++) H = Math.sqrt(Math.pow(y[q + 1] - y[q], 2) + Math.pow(z[q + 1] - z[q], 2)), a.distances[q] = H;
                    ...
                    if ("none" != E) {
                        var I, J, K;
                        if ("end" == E || "both" == E) v = y[y.length - 1], A = z[z.length - 1], 1 < y.length ? (C = y[y.length - 2], I = z[z.length -
                            2]) : (C = v, I = A), I = 180 * Math.atan((A - I) / (v - C)) / Math.PI, isNaN(D) || (I += D), J = v, K = A, I = 0 > v - C ? I - 90 : I + 90;
                        t = [-r / 2 - .5, -.5, r / 2 - .5];
                        k = [r, -.5, r];
                        a.shiftArrow && "middle" != E && (k = [0, 1.2 * -r, 0]);
                        "both" == E && (r = e.polygon(w, t, k, n, p, 1, n, p, void 0, !0), x.push(r), r.translate(J, K, 1 / m, !0), isNaN(I) || r.rotate(I), e.setCN(c, q, "map-line-arrow"), void 0 != a.id && e.setCN(c, q, "map-line-arrow-" + a.id), a.fixedSize && f.push(r));
                        if ("start" == E || "both" == E) r = y[0], K = z[0], 1 < y.length ? (v = y[1], J = z[1]) : (v = r, J = K), I = 180 * Math.atan((K - J) / (r - v)) / Math.PI, isNaN(D) ||
                            (I -= D), J = r, I = 0 > r - v ? I - 90 : I + 90;
                        "middle" == E && (v = y[y.length - 1], A = z[z.length - 1], 1 < y.length ? (C = y[y.length - 2], I = z[z.length - 2]) : (C = v, I = A), J = C + (v - C) / 2, K = I + (A - I) / 2, I = 180 * Math.atan2(A - I, v - C) / Math.PI, isNaN(D) || (D = H / 2, G -= Math.sqrt(G * G - D * D), v >= C ? 0 > B && (G = -G) : 0 < B && (G = -G), J -= Math.sin(I / 180 * Math.PI) * G, K += Math.cos(I / 180 * Math.PI) * G), I += 90);
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                if (1 < this.longitudes.length) {
                    ...
                    d = d.y;
                    g = l.y
                } else 1 < this.x.length && (c = this.x[b], e = this.x[b + 1], d = this.y[b], g = this.y[b + 1]);
                h = c + (e - c) * a;
                k = d + (g - d) * a;
...
(function() {
    ...
    e.normalizePath = function(a) {
        for (var b = "", c = e.parsePath(a.getAttribute("d")), d, f, g = Infinity, h = -Infinity, k = Infinity, l = -Infinity, n = 0; n < c.length; n++) {
            ...
            "v" == p && (p = "L", r = d, m += f);
            "V" == p && (p = "L", r = d);
            if ("m" === p || "l" === p) p = p.toUpperCase(), r += d, m += f;
            r = e.roundTo(r, 3);
            m = e.roundTo(m, 3);
            d = r;
            f = m;
    ...
    e.winkel3.invert = function(a, b) {
        ...
        do var h = Math.cos(d),
            ...
            q = t * t,
            u = 1 - m * r * r,
            C = u ? e.acos(h * r) * Math.sqrt(v = 1 / u) : v = 0,
            v, u = .5 * (2 * C * h * t + c / g) - a,
            B = .5 * (C * k + d) - b,
            y = .5 * v * (m * q + C * h * r * n) + .5 / g,
            E = v * (p * l / 4 - C * k * t),
            k = .125 * v * (l * t - C * k * m * p),
            n = .5 * v * (n * r + C * q * h) + .5,
            h = E * k - n * y,
    ...
    e.eckert6 = function(a, b) {
        for (var c = Math.PI, d = (1 + c / 2) * Math.sin(b), e = 0, g = Infinity; 10 > e && 1E-5 < Math.abs(g); e++) b -= g = (b + Math.sin(b) - d) / (1 + Math.cos(b));
        d = Math.sqrt(2 +
            c);
    ...
    e.ValueLegend = e.Class({
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                void 0 !== k && (h = e.text(b, k, m, n, l, "left"), h.translate(0, l / 2 - 1), e.setCN(a, h, "value-legend-min-label"), g.push(h), h = h.getBBox().height);
                k = this.maxValue;
                void 0 === k && (k = e.formatNumber(a.maxValueReal, p));
                void 0 !== k && (h = e.text(b, k, m, n, l, "right"), h.translate(this.width,
                    l / 2 - 1), e.setCN(a, h, "value-legend-max-label"), g.push(h), h = h.getBBox().height);
                if (this.showAsGradient) c = e.rect(b, this.width, this.height, [c, d], 1, this.borderThickness, this.borderColor, 1, 0, 0), e.setCN(a, c, "value-legend-gradient"), c.translate(0, h), g.push(c);
                else
                    for (l = this.width / f, n = 0; n < f; n++) m = e.getColorFade(c, d, 1 * n / (f - 1)), m = e.rect(b, l, this.height, m, 1, this.borderThickness, this.borderColor, 1), e.setCN(a, m, "value-legend-color"), e.setCN(a, m, "value-legend-color-" + n), m.translate(l * n, h), g.push(m);
                d = c = 0;
                f = g.getBBox();
